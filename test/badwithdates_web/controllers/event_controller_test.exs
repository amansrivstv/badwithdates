defmodule BadwithdatesWeb.EventControllerTest do
  use BadwithdatesWeb.ConnCase

  import Badwithdates.EventsFixtures

  @create_attrs %{date: ~D[2025-07-23], description: "some description", title: "some title", category: :anniversary}
