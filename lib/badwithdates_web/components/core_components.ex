defmodule BadwithdatesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BadwithdatesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BadwithdatesWeb.Gettext, "errors", msg, opts)
    end
  end
